...
streamlit-project
├── src
│   ├── Chatbot.py           # Main entry point of the Streamlit application
│   ├── pages                # You need to name the directory "pages" for it to appear in the Streamlit left │   │        └── 1_Process Description.py                         # View Process Description
│        └── 2_FAQ.py                                         # View FAQ
