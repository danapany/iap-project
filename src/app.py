...
pg = st.navigation([
    ...
    # 관리자용
    st.Page("menu/90_Chatbot_Rag_Datapreprocess.py", title="[관리자] 챗봇 - RAG 학습데이터 전처리기", icon="⚙️"),
    st.Page("menu/90_Chatbot_Serpapi_Usage.py", title="[관리자] 챗봇 - SerpApi 사용량 모니터링", icon="⚙️"),

    st.Page("menu/91_Admin-Process_Description_Create.py", title="[관리자] 장애프로세스 - 쉬운설명 (생성용)", icon="⚙️"),
    st.Page("menu/92_Admin-FAQ_Create.py", title="[관리자] 장애프로세스 - FAQ (생성용)", icon="⚙️"),
    st.Page("menu/93_Admin-Keyword-based_question_Create.py", title="[관리자] 장애프로세스 - 챗봇 키워드버튼 (생성용)", icon="⚙️"),
