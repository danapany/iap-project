...
pg = st.navigation([
    ...
    st.Page("menu/1_Chatbot2.py", title="[목표1] 트러블 체이서 챗봇 (+이상징후)", icon="🕵️‍♂️"),
    st.Page("menu/1_Chatbot3.py", title="[목표1] 트러블 체이서 챗봇 (장애보고서학습)", icon="🕵️‍♂️"),
    st.Page("menu/2_Report_Gen_Assistant.py", title="[목표2] 분석 보고서 초안 생성 도우미", icon="📰"),
    st.Page("menu/3_Seasonality_Predictor.py", title="[목표3] 시즈널리티 통계", icon="📈"),
