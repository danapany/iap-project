...
pg = st.navigation([
    ...
    st.Page("menu/2_Create Report_dev.py", title="[개발용] 장애보고서 초안생성(2단계-개발중)", icon="🎯"),
    st.Page("menu/2_Create_Analysys_Report.py", title="[개발용] 장애보고서 초안생성(병합-claude pro필요)", icon="🎯"),
