...
question = "장애대응절차에 대해서 대분류를 7개로 정하고 단계별 해야할 내용을 정의하여 단계별로 설명을 쉽고 상세하게 작성해줘. 후속 조치에는 인시던트 처리와 문제관리 내용이 포함되도록 해줘"
...
question = "장애대응절차에 대해서 대분류를 7개로 정하고 하위 단계별 설명을 이해 하기 쉽게 도표 형식의 상세한 설명을 추가해줘"
